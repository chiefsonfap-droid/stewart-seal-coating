...
export const metadata: Metadata = {
  ...
  description:
    "Canadian staging terms for 2608341 Ontario Inc. Jobs: 50 percent deposit. Drone Condition Report is prepaid 129 CAD plus HST.",
  ...
  return (
    <main id="main" className="mx-auto max-w-2xl px-5 py-16 md:py-24">
      ...
      <p className="mt-4 text-base leading-relaxed text-[var(--paper-dim)]">
        Ontario law. 2608341 Ontario Inc. operating as Steward Seal Coating. This page is
        a Canadian stub for staging — not a live offer.
      </p>
      ...
      <section className="mt-12 border-t border-[var(--line)] pt-8">
        ...
        <p className="mt-3 text-sm leading-relaxed text-[var(--paper-dim)]">
          The report is prepaid at <strong className="text-[var(--paper)]">$129 CAD + HST</strong>.
          ...
          not redeemable for cash, expiring 90 days after report delivery unless we agree
      ...
      <section className="mt-8 border-t border-[var(--line)] pt-8">
        ...
        <p className="mt-3 text-sm leading-relaxed text-[var(--paper-dim)]">
          ...
          confirmed on the quote (cheque, e-transfer, or card when available). The prepaid
          $129 report is separate from this deposit schedule.
        </p>
      </section>
      ...
      <section className="mt-8 border-t border-[var(--line)] pt-8">
        ...
        <p className="mt-3 text-sm leading-relaxed text-[var(--paper-dim)]">
          On-site drone flights run about 60–90 minutes. We prioritize sites within about
          an hour of Sudbury and batch routes. Weather, airspace, and site access can move
          a slot; we will reschedule honestly.
        </p>
      </section>
